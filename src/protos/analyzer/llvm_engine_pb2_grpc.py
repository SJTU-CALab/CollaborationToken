...
class LLVMEngineStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AnalyseByteCode = channel.unary_unary(
                '/analyzer.LLVMEngine/AnalyseByteCode',
...
class LLVMEngineServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_LLVMEngineServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'analyzer.LLVMEngine', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))


 # This class is part of an EXPERIMENTAL API.
class LLVMEngine(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def AnalyseByteCode(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/analyzer.LLVMEngine/AnalyseByteCode',
